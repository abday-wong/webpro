...
const HeroSection = memo(function HeroSection({ isRevealed = true }) {
  ...
  return (
    <header
      ref={containerRef}
      id="hero-section"
      className="min-h-[100svh] w-full relative bg-[#030303] selection:bg-[#e60012] selection:text-white overflow-hidden flex flex-col items-center justify-center pt-16 pb-16"
    >
      {}
      <Gsap.div
        initial={false}
      ...
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(230, 0, 18,0.12),transparent_48%),linear-gradient(to_bottom,rgba(230, 0, 18,0.04),transparent_48%)]" />
        ...
        {}
        <div
          className="absolute top-1/2 left-1/2 w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] bg-[#e60012] rounded-full blur-[90px] lg:blur-[130px] opacity-[0.1]"
          style={enableAmbientMotion && isRevealed ? {
        ...
        />
        <div
          className="absolute top-1/4 right-[20%] w-[40vw] h-[40vw] max-w-[600px] max-h-[600px] bg-[#e60012] rounded-full blur-[90px] lg:blur-[120px] opacity-[0.06]"
          style={enableAmbientMotion && isRevealed ? {
      ...
      >
        ...
        >
          <button
            ...
            className="group flex items-center gap-2 bg-white text-black px-6 py-3 font-mono text-sm font-bold uppercase tracking-wider hover:bg-[#e60012] hover:text-black transition-all duration-300 cursor-pointer"
          >
