  ...
  return (
    <footer id="contact-section" className="bg-[#0A0A0A] text-white pt-20 md:pt-24 pb-12 w-full relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 md:px-12 relative z-10 flex flex-col justify-between min-h-[50vh]">
        ...
        >
          <div className="w-2 h-2 bg-[#e60012] rounded-[2px] animate-pulse" />
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 md:gap-16 lg:gap-8 mb-20 md:mb-24">
          ...
          <div className="lg:w-1/2 flex flex-col justify-between">
            <div>
              <h2 className="text-4xl sm:text-7xl lg:text-8xl font-black uppercase tracking-tighter leading-[0.95] sm:leading-[0.9] text-white mb-6">
                LET'S <br />
                <span className="text-[#e60012] transform inline-block italic pr-4">CONNECT.</span>
              </h2>
          ...
          <div className="lg:w-1/2 flex flex-col sm:flex-row gap-12 sm:gap-16 lg:justify-end">
            ...
            <div className="flex flex-col gap-4">
              ...
              {[
                ...
                <button
                  ...
                  className="text-left font-mono text-xs md:text-sm font-bold uppercase text-white/60 hover:text-[#e60012] transition-colors flex items-center gap-3 group py-1"
                >
                  <span className="w-1.5 h-1.5 bg-white/20 group-hover:bg-[#e60012] transition-colors" />
                  <span className="tracking-[0.14em] md:tracking-[0.2em] relative">
                    {item.label}
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#e60012] group-hover:w-full transition-all duration-300" />
                  </span>
                </button>
              ))}
            </div>
            ...
            <div className="flex flex-col gap-4 min-w-[200px]">
              <span className="font-mono text-[10px] text-white/30 uppercase tracking-[0.18em] md:tracking-[0.24em] mb-4 border-l-2 border-[#e60012] pl-3">Networks</span>
              ...
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex items-center justify-between border border-white/10 bg-[#111111] hover:bg-[#e60012] hover:border-[#e60012] transition-colors duration-300 p-3"
                >
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-4">
          <div className="flex items-center gap-3 font-mono text-[10px] md:text-xs text-white/40 uppercase tracking-[0.14em] md:tracking-[0.2em]">
            ...
            <div className="flex items-center gap-2 text-[#e60012] bg-[#e60012]/10 px-2 flex-grow-0 min-w-16 justify-center py-0.5 border border-[#e60012]/20 yg">
              ONLINE
            </div>
          </div>
