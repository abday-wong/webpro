        ...
        <div className="flex items-start justify-between gap-5">
          <div className="flex-1">
            ...
            <div className="flex items-baseline gap-3 mb-3">
              ...
              <h3 className="font-display font-bold text-[22px] md:text-[26px] tracking-[-0.022em] text-black leading-[0.98]">
                {achievement.title}
              </h3>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2.5">
              ...
              <div className="bg-white border border-black/[0.08] rounded-[3px] py-3.5 px-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[13px] font-bold text-black">{PORTFOLIO_DATA.profile.location}</span>
                </div>
              </div>
            </div>
